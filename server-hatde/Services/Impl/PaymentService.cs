...
namespace CarRentalSystem.Infrustructure
{
    public class PaymentService : IPaymentService
    {
        ...
        public PaymentService(IConfiguration configuration, WeddingDbContext dbContext)
        {
        ...
        public async Task<string> CreatePaymentVnPay(PaymentRequest model, HttpContext context)
        {
            ...
            pay.AddRequestData("vnp_OrderInfo", $"booking_{model.BookingId}");
        ...
        public async Task<bool> PayByCashAsync(int bookingId, decimal totalAmount)
        {
            var payment = new Payment()
            {
                BookingId = bookingId,
